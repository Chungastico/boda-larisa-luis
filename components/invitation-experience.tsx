      ...
      >
        ...
        <section id="cuenta-regresiva" className="story-screen relative isolate overflow-hidden bg-[#2a2a1c] text-center text-[#f4eee2]">
          ...
          <img
            ...
            alt=""
            className="absolute left-[40.2083%] top-[345px] h-auto w-[281px] max-w-[72%] -translate-x-1/2"
          />
          <p data-invitation-reveal className="absolute left-[61.6667%] top-[415px] -translate-x-1/2 whitespace-nowrap text-[26px] font-bold uppercase tracking-[1px]">
            Falta poco
          </p>
          <div data-invitation-reveal className="absolute inset-x-0 top-[599px] px-4"><Countdown /></div>
        </section>
